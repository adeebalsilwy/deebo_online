...
class _EditDataState extends State<EditData> {
  ...
  void initState() {
    super.initState();
    _fetchCategories();
    controllerCode.text = widget.list.itemCode.toString();
    controllerName.text = widget.list.itemName.toString();
    controllerPrice.text = widget.list.price.toString();
    controllerStock.text = widget.list.stock.toString();
    _categoryId = widget.list.categoryId;
  }
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: _image != null
                            ...
                            : DecorationImage(
                                image: NetworkImage(
                                    '${AppData.url}${widget.list.imagePro}'),
                                fit: BoxFit.cover,
                                //widget.list[widget.index].id
                              ),
                      ),
...
class showMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: AlertDialog(
        title: Text("Data has been update secssfully"),
        actions: [
          TextButton(
